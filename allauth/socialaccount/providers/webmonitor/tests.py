...
class WebmonitorTests(OAuth2TestsMixin, TestCase):
    ...
    def get_mocked_response(self,
        ...
        return MockedResponse(200, """
              {"family_name": "%s", "name": "%s",
               "picture": "https://lh5.webmonitorusercontent.com/photo.jpg",
               "locale": "nl", "gender": "male",
               "email": "%s",
               "link": "https://plus.webmonitor.com/108204268033311374519",
    ...
    def test_webmonitor_compelete_login_401(self):
        ...
        with patch(
                'allauth.socialaccount.providers.webmonitor.views'
    ...
    def test_account_connect(self):
        ...
        self.assertTrue(SocialAccount.objects.filter(
            user=user,
            provider=WebmonitorProvider.id).exists())
